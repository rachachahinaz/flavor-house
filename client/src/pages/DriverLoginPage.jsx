...
const DriverLoginPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Driver credentials (hardcoded for demo)
    if (credentials.email === 'driver@flavorhouse.dz' && credentials.password === 'driver123') {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-red-800">Driver Login</h1>
          <p className="text-gray-500 mt-2">Access the delivery dashboard</p>
        </div>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                type="email"
                name="email"
                placeholder="driver@flavorhouse.dz"
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-500">
            Demo credentials: driver@flavorhouse.dz / driver123
          </p>
        </div>
      </div>
    </div>
